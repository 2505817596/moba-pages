import{g as a}from"./nativeXRFrame-CwfwtEd1.js";const e="fluentVertexShader",r=`attribute position: vec3f;attribute normal: vec3f;attribute uv: vec2f;uniform world: mat4x4f;uniform viewProjection: mat4x4f;varying vUV: vec2f;
#ifdef BORDER
...
`;a.ShadersStoreWGSL[e]||(a.ShadersStoreWGSL[e]=r);const l={name:e,shader:r};export{l as fluentVertexShaderWGSL};
